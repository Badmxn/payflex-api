...
const fraudCheck = async (req, res, next) => {
    try {
        ...
        const dailyTotal = await prisma_1.default.transaction.aggregate({
        ...
        const recentCount = await prisma_1.default.transaction.count({
        ...
        const duplicate = await prisma_1.default.transaction.findFirst({
            where: {
                userId,
                recipient,
                email,
